...
- When the user says **billybobgames开工** (preferred) or **开工**: load and summarize `WORKLOG.md` in this repo (current goal, status, next steps), then ask what to do next in this repo.
- When the user says **收工** (or **billybobgames收工**):
