(function() {
    ...
    UI.prototype.__initBtnHelp = function() {
		...
		var aboutme = my.DOM.get('btnAboutMe');
		var str ="Thanks for playing!\nThis button is just a playful extra.\nHave feedback or found a bug?\nDrop a note and keep smashing those moles!"
	 ...
	 UI.prototype.__initMouseEventListener=function(){
	     ...
	     canvas.onmousemove = function(e){
		  	 if(self.hammer){
		        ...
		        self.hammer.x = pos.x - self.hammer.width / 2;
		        self.hammer.y = pos.y - self.hammer.height / 2;
	          }
		 }
	     ...
	     canvas.onmouseup = function(e){
			 ...
			 var pos = getPointerPosition(e);
			 self.__pengzhuang(self,pos.x, pos.y);
	 }		 
	 }
