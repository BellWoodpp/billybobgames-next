...
{	
	...
	var degree = this._computeCannonDegree(targetPoint);
	cannon.fire(degree);
...
Player.prototype.aim = function(targetPoint)
{
	if(!targetPoint) return;
	var degree = this._computeCannonDegree(targetPoint);
	this.cannon.rotation = degree;
};

Player.prototype._computeCannonDegree = function(targetPoint)
{
	var dir = ns.Utils.calcDirection(this.cannon, targetPoint), degree = dir.degree;
